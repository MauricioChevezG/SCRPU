...
//AFECTACION DE AREAS DE PROTECCION
	...
	public function guardar()
	{
		...
		$sql = "SP03_REGTRA_GUARDAR(IN IDTRA INT(11), IN FETRA DATE, IN IDTFR INT(11),
 IN IDGPS INT(11), IN IDTDESEC INT(11), IN IDPLAN INT(11), IN IDCLAS INT(11), IN IDACTDES INT(11),
  IN IDDEG INT(11), IN IDASBIO INT(11), IN IDAAP INT(11), IN IDSERVID INT(11), IN IDSERVI INT(11),
   IN IDDESAS INT(11), IN IDREDVI INT(11), IN IDINFR INT(11), IN IDUBICN INT(11), IN IDUBICS INT(11),
    IN IDTIPS INT(11), IN IDCUSO INT(11))"
