		...
		<div class="row">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<ul class="list-group">
						<li class="list-group-item"><strong>ID Servicio de Red Vial: </strong><?php echo $this->class22serrvi->getAtributo('PU22IDREDVI');?></li>
						<li class="list-group-item"><strong>DESCIPCION: </strong><?php echo $this->class22serrvi->getAtributo('PU22DESSVI');?></li>
						<li class="list-group-item"><strong>OBSERVACIONES DEL SERVICIO: </strong><?php echo $this->class22serrvi->getAtributo('PU22OBSERV');?></li>
