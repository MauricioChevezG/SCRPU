...
insert  into `pu04regtra`(`PU04IDTRA`,`PU04FETRA`,`PU04NORTE`,`PU04ESTE`,`PU04ALTITUD`) values (1,'0000-00-00',2,3,4),(2,'0000-00-00',2334,2344,2333),(3,'0000-00-00',1,1,1),(4,'0000-00-00',111,111,11),(5,'0000-00-00',11,11,11);
...
CREATE TABLE `pu07traterrft` (
  `PU04IDTRA` int(11) NOT NULL,
  `PU07IDTFR` int(11) NOT NULL,
  KEY `FK_PU07IDTFRTRA` (`PU04IDTRA`),
  KEY `FK_PU07IDTFRTRAT` (`PU07IDTFR`),
  CONSTRAINT `FK_PU07IDTFRTRA` FOREIGN KEY (`PU04IDTRA`) REFERENCES `pu04regtra` (`PU04IDTRA`),
...
CREATE TABLE `pu12tratipdesec` (
  `PU04IDTRA` int(11) NOT NULL,
  `PU12IDTDESEC` int(11) NOT NULL,
  KEY `FK_PU04IDTRATRA` (`PU04IDTRA`),
  KEY `FK_PU12IDTDESEC` (`PU12IDTDESEC`),
  CONSTRAINT `FK_PU04IDTRATRA` FOREIGN KEY (`PU04IDTRA`) REFERENCES `pu04regtra` (`PU04IDTRA`),
...
BEGIN
--   SELECT DISTINCT 
--     pu04regtra.PU04IDTRA AS 'Numero Trámite',
--     pu04regtra.PU04FETRA AS 'Fecha',
--     pu07terrft.PU07NOMTFR AS 'T.F.R',
--     pu04regtra.PU04NORTE AS 'Norte',
--     pu04regtra.PU04ESTE AS 'Este',
--     pu04regtra.PU04ALTITUD AS 'Altitud',
--     pu12tipdesec.PU12TIPODES AS 'Tipo Desarrollo' 
--   FROM
--     (
--       (
...
--           ON pu04regtra.PU12IDTDESEC = pu12tipdesec.PU12IDTDESEC
--       ) 
--       INNER JOIN pu07terrft 
--         ON pu04regtra.`PU07IDTFR` = pu07terrft.PU07IDTFR
--     ) ;
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `SP04_REGISTROTR_GUARDAR`( IN IDTRA INT(11), IN FETRA DATE, 
...
INSERT INTO pu04regtra (PU04IDTRA, PU04FETRA,PU04NORTE,PU04ESTE,PU04ALTITUD)
 VALUES (IDTRA,FETRA,PU04NORTE,PU04ESTE,PU04ALTITUD);
END */$$
DELIMITER ;
...
/* Procedure structure for procedure `SP07_TERRFT_TRA_GUARDAR` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP07_TERRFT_TRA_GUARDAR` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`mauricio`@`localhost` PROCEDURE `SP07_TERRFT_TRA_GUARDAR`(IN IDTRA INT(11),IN IDTFR INT(11))
BEGIN
...
/* Procedure structure for procedure `SP12_TIPDESEC_TRA_GUARDAR` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP12_TIPDESEC_TRA_GUARDAR` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`mauricio`@`localhost` PROCEDURE `SP12_TIPDESEC_TRA_GUARDAR`(IN IDTRA INT(11),IN IDTDESEC INT(11))
BEGIN
	INSERT INTO pu12tratipdesec (PU04IDTRA,`PU12IDTDESEC`)
	VALUES (IDTRA,IDTDESEC);
    END */$$
DELIMITER ;
