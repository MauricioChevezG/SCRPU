...
/* Procedure structure for procedure `SP07_TFR_BUSCAR` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP07_TFR_BUSCAR` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `SP07_TFR_BUSCAR`(IN IDTFR INT(11))
BEGIN
SELECT * FROM `pu07terrft` WHERE `PU07IDTFR` = IDTFR;
END */$$
DELIMITER ;

/* Procedure structure for procedure `SP07_TFR_MOSTRAR` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP07_TFR_MOSTRAR` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `SP07_TFR_MOSTRAR`()
BEGIN
SELECT * FROM `pu07terrft`;
END */$$
DELIMITER ;

/* Procedure structure for procedure `SP08_GPS_BUSCAR` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP08_GPS_BUSCAR` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `SP08_GPS_BUSCAR`(IN IDGPS INT(11))
BEGIN
...
/* Procedure structure for procedure `SP26_PLANREG_A` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP26_PLANREG_A` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `SP26_PLANREG_A`(IN idplan INT(11),IN plandes VARCHAR(30))
BEGIN
...
/* Procedure structure for procedure `SP26_PLANREG_E` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP26_PLANREG_E` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `SP26_PLANREG_E`(IN idplan INT(11))
BEGIN
...
/* Procedure structure for procedure `SP26_PLANREG_G` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP26_PLANREG_G` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `SP26_PLANREG_G`( IN idplan INT (11), IN plandes VARCHAR(30))
BEGIN
...
/* Procedure structure for procedure `SP27_CUINIC_A` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP27_CUINIC_A` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `SP27_CUINIC_A`(IN idubic INT(11),IN dscubic VARCHAR(30))
BEGIN
...
/* Procedure structure for procedure `SP27_CUINIC_E` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP27_CUINIC_E` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `SP27_CUINIC_E`(IN idubic INT)
BEGIN
...
/* Procedure structure for procedure `SP27_CUINIC_G` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP27_CUINIC_G` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `SP27_CUINIC_G`( IN idubic INT (11), IN dscubic VARCHAR(30))
BEGIN
...
/* Procedure structure for procedure `SP28_CUISAM_A` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP28_CUISAM_A` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `SP28_CUISAM_A`(IN idubic INT(11),IN dscubic VARCHAR(30))
BEGIN
...
/* Procedure structure for procedure `SP28_CUISAM_E` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP28_CUISAM_E` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `SP28_CUISAM_E`(IN idubic INT)
BEGIN
	DELETE FROM pu28cuisam WHERE PU28IDUBIC=idubic;
...
/* Procedure structure for procedure `SP28_CUISAM_G` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP28_CUISAM_G` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `SP28_CUISAM_G`( IN idubic INT (11), IN dscubic VARCHAR(30))
BEGIN
...
/* Procedure structure for procedure `SP32_CAPUSO_A` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP32_CAPUSO_A` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `SP32_CAPUSO_A`(IN idcuso INT(11),IN dscuso VARCHAR(30))
BEGIN
...
/* Procedure structure for procedure `SP32_CAPUSO_E` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP32_CAPUSO_E` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `SP32_CAPUSO_E`(IN idcuso INT)
BEGIN
...
/* Procedure structure for procedure `SP32_CAPUSO_G` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP32_CAPUSO_G` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `SP32_CAPUSO_G`( IN idcuso INT (11), IN dscuso VARCHAR(30))
BEGIN
...
/* Procedure structure for procedure `SP34_CLASES_A` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP34_CLASES_A` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `SP34_CLASES_A`(IN idclas INT(11),IN desclas INT (11))
BEGIN
...
/* Procedure structure for procedure `SP34_CLASES_E` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP34_CLASES_E` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `SP34_CLASES_E`(IN idclas INT(11))
BEGIN
...
/* Procedure structure for procedure `SP34_CLASES_G` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP34_CLASES_G` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `SP34_CLASES_G`( IN idclas INT (11), IN desclas INT (11))
BEGIN
...
/* Procedure structure for procedure `SP35_TIPSUE_A` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP35_TIPSUE_A` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `SP35_TIPSUE_A`(IN idtipsue INT(11),IN dstipsue VARCHAR(30))
BEGIN
...
/* Procedure structure for procedure `SP35_TIPSUE_E` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP35_TIPSUE_E` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `SP35_TIPSUE_E`(IN idtipsue INT)
BEGIN
...
/* Procedure structure for procedure `SP35_TIPSUE_G` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP35_TIPSUE_G` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `SP35_TIPSUE_G`( IN idtipsue INT (11), IN dstipsue VARCHAR(30))
BEGIN
